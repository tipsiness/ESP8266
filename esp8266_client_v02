...
String data;
//String server = "kook.ngrok.io"; // www.example.com
String server = "192.168.10.56"; 

String uri = "/";// our example is /esppost.php

int DHpin = 8;//sensor pin
byte dat [5];
String dev_id, temp ,humi;
...
void loop () {
  ...
  data = "dev_id=" + dev_id + "&temp=" + temp + "&humi=" + humi;// data sent must be under this form //name1=value1&name2=value2.
...
void httppost () {
  esp.println("AT+CIPSTART=\"TCP\",\"" + server + "\",9999");//start a TCP connection.
